...
<body>
<h2>Consultation du profil d'un élève</h2>
<br>
<div align="center">
Veuiller sélectionner l'élève pour lequel vous voulez afficher son profil :<br><br>
<?php
	$dbhost = 'tuxa.sme.utc';
	$dbuser = 'nf92a032';
	$dbpass = 'VxC3CvUn';
...
echo "<form action='consulter_eleve.php' method='POST'>";
	...
	echo "<BR>";
		...
		echo "<INPUT type='submit' value='Visualiser le profil'>";
